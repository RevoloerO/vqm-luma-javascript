    ...
    return (
        <div className="mind-map-view">
            ...
            {data.nodes.map((node, index) => (
                <div key={index} className="mind-map-node" style={{ left: `${nodePositions[index].x}%`, top: `${nodePositions[index].y}%` }}>
        ...
        <div className="topic-page-container">
            ...
            <main className="topic-content">
                <div className="topic-header">
                    ...
                    {/* Show toggle buttons only if mind map data exists for the active topic */}
                    {activeTopic.mindMap && (
                ...
                {/* Conditionally render the view based on the viewMode state */}
